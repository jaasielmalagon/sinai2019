  ...
  <v-form>
    <v-container>
      <v-row>
        <v-col xs="12">
          <v-card>
            <v-toolbar color="#0051A0" dark>
              <v-toolbar-title>Datos personales del solicitante</v-toolbar-title>
            </v-toolbar>
            <v-card-text>
              <v-row>
                <v-col cols="12" md="6">
      ...
      <!-- <v-row>
          <v-col xs="12">
            <v-card>
              <v-toolbar dense dark color="#0051A0">
                <v-toolbar-title>Actividad económica</v-toolbar-title>
              </v-toolbar>
              <v-card-text>
                <v-row>
                  <v-col cols="12" xs="6">
                    <v-text-field
                      ...
                      label="Ocupación"
                      required
                      @input="$v.cliente.ocupacion.$touch()"
                      @blur="$v.cliente.ocupacion.$touch()"
                      @keyup="uppercasedOcupacion"
                    ></v-text-field>
                  </v-col>
                  <v-col cols="12" xs="6">
                    <v-text-field
        ...
        <v-row>
          <v-col xs="6">
            <v-card>
              <v-toolbar dense dark color="#0051A0">
                <v-toolbar-title>Ingresos diarios</v-toolbar-title>
              </v-toolbar>
              <v-card-text>
                <v-row>
                  <v-col xs="8">
          ...
          <v-col xs="6">
            <v-card>
              <v-toolbar dense dark color="#0051A0">
                <v-toolbar-title>Egresos diarios</v-toolbar-title>
              </v-toolbar>
              <v-card-text>
                <v-row>
                  <v-col xs="8">
      ...
      <!-- <v-row>
          <v-col xs="12">
            <v-card>
              <v-toolbar dense dark color="#0051A0">
                <v-toolbar-title>Características del establecimiento comercial</v-toolbar-title>
              </v-toolbar>
              <v-card-text>
                <v-row>
                  <v-col xs="12">
                    <v-text-field
                      v-model="cliente.ocupacion"
                      :error-messages="ocupacionErrors"
                      label="TIEMPO DE LABORAR EN EL NEGOCIO(AÑOS)"
                      required
                      @input="$v.cliente.ocupacion.$touch()"
                      @blur="$v.cliente.ocupacion.$touch()"
                      @keyup="uppercasedOcupacion"
                ...
                <v-row>
                  <v-col xs="12">
                    <v-text-field
                      v-model="cliente.ocupacion"
                      :error-messages="ocupacionErrors"
                      label="¿EL NEGOCIO SE ENCUENTRA EN UN ESTABLECIMIENTO FIJO?"
                      required
                      @input="$v.cliente.ocupacion.$touch()"
                      @blur="$v.cliente.ocupacion.$touch()"
                      @keyup="uppercasedOcupacion"
...
export default {
  ...
  computed: {
    ...
    ocupacionErrors() {
      const errors = [];
      if (!this.$v.cliente.ocupacion.$dirty) return errors;
      !this.$v.cliente.ocupacion.minLength &&
        errors.push("La ocupacion es incorrecta");
      !this.$v.cliente.ocupacion.required &&
        errors.push("Este campo es obligatorio.");
      return errors;
    }
  }
